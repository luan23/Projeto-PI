                    ...
                    <div class="row">
                        <div class="col-lg-12">
                           <div class="alert alert-danger">
                               <strong>Aqui você poderá ver ocorrências visualizadas pelo sindico com a resposta.(Caso o responsável responda.)</strong>
                           </div>
                        </div>
                    </div>
                    <!-- /.row -->
                            ...
                            <div class="table-responsive">
                                ...
                                <table class="table table-bordered table-hover table-striped">
                                    ...
                                    <tbody>
                                        ...
                                        <tr class="success">
                                            <td>1</td>
                                            <td>Portão aberto depois das 23h</td>
                                            <td>Foi passado uma advertência para a portaria, para que se tome medidas relacionado a isso</td>
                                        </tr>
